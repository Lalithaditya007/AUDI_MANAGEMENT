    ...
    <div className="min-h-screen flex flex-col">
      ...
      <section className="py-20 relative overflow-hidden">
        ...
        >
          ...
          {/* Updated container styling with themed border and wider width */}
        ...
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            <motion.h2 
              ...
              className="text-4xl font-bold mb-4 text-[#82181A]"
            >
              Featured Auditoriums
            </motion.h2>
            <p className="text-lg text-gray-600 max-w-2xl mx-auto">
              Explore our premium facilities designed to accommodate various events
            </p>
            <motion.div
              initial={{ width: 0 }}
              whileInView={{ width: "100px" }}
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            >
              <div className="h-64 overflow-hidden relative">
                ...
                <div className="absolute bottom-0 left-0 right-0 p-5 z-20">
                  <h3 className="text-2xl font-bold text-white">KS Auditorium</h3>
                  <p className="text-white/80 text-sm">500 Seats</p>
                </div>
              </div>
              <div className="p-6">
                <p className="text-gray-600 mb-4">Our flagship auditorium with state-of-the-art AV equipment and ample seating for large events.</p>
                <a href="/ks-auditorium" className="text-red-600 font-medium flex items-center group-hover:text-red-700">
                  View Details
            ...
            >
              <div className="h-64 overflow-hidden relative">
                ...
                />
                <div className="absolute bottom-0 left-0 right-0 p-5 z-20">
                  <h3 className="text-2xl font-bold text-white">B Block Seminar Hall</h3>
                  <p className="text-white/80 text-sm">200 Seats</p>
                </div>
              </div>
              <div className="p-6">
                <p className="text-gray-600 mb-4">A versatile space perfect for workshops, seminars and academic presentations.</p>
                <a href="/b-block-seminar-hall" className="text-red-600 font-medium flex items-center group-hover:text-red-700">
                  View Details
                  <svg className="w-4 h-4 ml-2 transform transition-transform group-hover:translate-x-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M14 5l7 7m0 0l-7 7m7-7H3" />
                  </svg>
            ...
            >
              <div className="h-64 overflow-hidden relative">
                ...
                />
                <div className="absolute bottom-0 left-0 right-0 p-5 z-20">
                  <h3 className="text-2xl font-bold text-white">PEB Training Hall</h3>
                  <p className="text-white/80 text-sm">150 Seats</p>
                </div>
              </div>
              <div className="p-6">
                <p className="text-gray-600 mb-4">A dedicated hall for training sessions, technical workshops and small conferences.</p>
                <a href="/peb-hall" className="text-red-600 font-medium flex items-center group-hover:text-red-700">
                  View Details
                  <svg className="w-4 h-4 ml-2 transform transition-transform group-hover:translate-x-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M14 5l7 7m0 0l-7 7m7-7H3" />
                  </svg>
      ...
      <section className="py-20 bg-red-50 relative overflow-hidden">
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="text-center mb-16">
            ...
            <p className="text-lg text-gray-600 max-w-2xl mx-auto">
              Feedback from departments and organizations that used our facilities
            </p>
            <motion.div
              initial={{ width: 0 }}
              whileInView={{ width: "100px" }}
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            >
              {/* Quote mark */}
              <div className="absolute top-4 right-4 text-red-100 text-6xl font-serif">❞</div>
              
              <p className="text-gray-600 italic mb-6 relative z-10">
                "The booking process was incredibly simple and the technical support team was very helpful during our tech conference. Will definitely book again!"
              </p>
              ...
              <div className="flex items-center">
                ...
                <div className="ml-4">
                  <h4 className="font-semibold">Computer Science Dept.</h4>
                  <p className="text-sm text-gray-500">Annual Tech Summit</p>
                </div>
              </div>
            </motion.div>
            ...
            >
              ...
              <p className="text-gray-600 italic mb-6 relative z-10">
                "The KS Auditorium was perfect for our cultural festival. The acoustics and lighting setup exceeded our expectations. Thank you for the smooth experience!"
              </p>
              ...
              <div className="flex items-center">
                ...
                <div className="ml-4">
                  <h4 className="font-semibold">Cultural Association</h4>
                  <p className="text-sm text-gray-500">Annual Cultural Fest</p>
                </div>
              </div>
            </motion.div>
            ...
            >
              ...
              <p className="text-gray-600 italic mb-6 relative z-10">
                "As an alumni association, we host regular events, and the institution's booking portal has made reservation process seamless. Excellent facilities and staff support!"
              </p>
              ...
              <div className="flex items-center">
                ...
                <div className="ml-4">
                  <h4 className="font-semibold">Alumni Association</h4>
                  <p className="text-sm text-gray-500">Annual Reunion</p>
                </div>
              </div>
            </motion.div>
          </div>
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <motion.p
              ...
              transition={{ duration: 0.6, delay: 0.2 }}
              viewport={{ once: true }}
              className="text-xl text-red-100 mb-10 max-w-3xl mx-auto"
            >
              From department seminars to cultural celebrations, our auditoriums provide the perfect setting for your campus events. Book now and make your event memorable!
            </motion.p>
            ...
            >
              ...
              <motion.a
                ...
                whileTap={{ scale: 0.95 }}
                href="/auditoriums"
                className="px-8 py-4 bg-transparent border-2 border-white text-white rounded-lg font-bold text-lg shadow-lg hover:bg-white/10 transition-all duration-300"
              >
                Explore Options
              </motion.a>
            </motion.div>
